...
Anyone can sign up for a Citra Space app account to explore the platform's features. Follow the steps below to create your account.
...
![Create an account](../guides-and-tutorials/img/login-screen.png)
Choose `Create an account` in the Sign in form.

![Create an account](../guides-and-tutorials/img/signup-form.png)
